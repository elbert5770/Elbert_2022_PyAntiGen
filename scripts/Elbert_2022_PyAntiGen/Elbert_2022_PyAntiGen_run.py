...
def run_simulation():
    ...
    r_prelim = TelluriumGen(model_text, MODEL_NAME, repo_root)
    V_SP3_0 = r_prelim['V_SP3_0']
    Q_CSF = r_prelim['Q_CSF']
    V_LP = r_prelim['V_LP']
    t_CSFdraw = r_prelim['t_CSFdraw']
    results = []
    for spec in EXPERIMENTS:
        df = spec["load_data"](data_path)
        events = spec["event_func"](df,Q_CSF,V_SP3_0,V_LP,t_CSFdraw)
